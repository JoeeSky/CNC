...
public class ProgramTaskAction extends ActionSupport {
...
//	private File upload;
	...
	public String uploadFile() throws Exception {
		...
		programTaskAttachmentService.add(programTaskId,fileType,uploadFileName,taskFilePath+"/"+uploadFileName);
		//建立文件上传的缓存读和写的流
		...
		public String addProgramTask () throws  Exception{
			String rootPath = ServletActionContext.getRequest().getRealPath(CommonConstant.SAVE_PATH);//根目录
			Map session = ActionContext.getContext().getSession();
			...
			programTaskService.add(taskName,demanderId,demanderUserId,description,filePath);
			JSONObject jsonObject = new JSONObject();
		...
		public String deleteCnc() throws  Exception{
			programTaskService.deleteProgramTaskCnc(tid);
			JSONObject jsonObject = new JSONObject();
			jsonObject.put("info", true);
			sentMsg(jsonObject.toString());
			return null;
		...
		public String deleteProgramTask() throws  Exception{
			programTaskService.deleteProgramTask(tid);
			JSONObject jsonObject = new JSONObject();
			jsonObject.put("info", true);
			sentMsg(jsonObject.toString());
			return null;
		...
		public String makeSureComplete() throws  Exception{
			programTaskService.makeSureComplete(tid);
			JSONObject jsonObject = new JSONObject();
			jsonObject.put("info", true);
			sentMsg(jsonObject.toString());
			return null;
		...
		public String getStatusList() throws Exception{
			List result=null;
			result=statusService.getStatusList();
			JSONObject jsonObject = new JSONObject();
		...
		public int getProgramTaskId() {
			return programTaskId;
		}

		public void setProgramTaskId(int programTaskId) {
