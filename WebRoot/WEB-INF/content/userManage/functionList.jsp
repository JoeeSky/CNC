...
<body>
	...
	<div class="row">
		<div class="col-sm-2 pull-right">
			<a class="btn btn-primary btn-sm  pull-right" style="margin:0 10px 20px 30px;" href="function/addInput">添加功能</a>
	</div></div>
		<!-- 条件搜索 begin-->
		<%-- <div class="row">
	...
	<script>
		function formatUser(cellvalue, options, rowObject){
			...
			return "<a  target='_blank' href='function/info?tid="+cellvalue.id+"'>"+cellvalue.name+"</a>";
		}
		...
		$(document).ready(function() {
		    ...
		    $("#jqgrid").length > 0 && (t.jqGrid({
		    	url:"function/listAjax.ajax",
		    	mtype:"GET",
		    	datatype:"json",
		    	colNames:['模块','功能列表','是否启用','排序','操作'],
		    	height:410,
		    	rowNum:<s:property value="@org.nfmedia.crms.cons.CommonConstant@DEFAULT_PAGE_SIZE"/>,
		    	rowList: [10, 20, 30],
        		pager: "jqgrid-pager",
        		multiselect: !0,
        		editurl:"function/edit.ajax",
        		sortname:"id",
        		sortorder: "asc",
        		viewrecords: !0,
        		colModel:[{
